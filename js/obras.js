// obras.js - CRUD de obras, listagem com paginação + listener híbrido, subcoleções, visualização GLOBAL
...
async function carregarPagina(direcao) {
    // REMOVIDO o filtro .where('unidade', '==', ...) para carregar obras de TODAS as unidades
...
function atualizarFiltrosVendedor() {
    ...
    if (filtroUnidade) filtroUnidade.innerHTML = htmlUnidades;
}
...
// ==================== LISTAGEM (com filtro por unidade) ====================
