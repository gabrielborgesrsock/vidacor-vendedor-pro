...
function iniciarMapa() {
    if (!mapa) {
        ...
        // Camada de lojas com ícone personalizado (emoji)
        ...
        // Observer para trocar tema dos tiles
            ...
            snapshot.forEach(doc => {
                ...
                const icon = L.divIcon({
                    html: `<div style="
                        ...
                        background:#3E3B9F; color:white; font-size:0.55rem;
